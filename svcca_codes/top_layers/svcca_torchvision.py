...
model_groups = {
    'full': {
        'ft1': '/weights_1/shufflenet_v2_ft_1/best_model_shufflenet_v2_ft.pth',
        'ft2': '/weights_2/shufflenet_v2_ft_2/best_model_shufflenet_v2_ft.pth',
        'ft3': '/weights_3/shufflenet_v2_ft_3/best_model_shufflenet_v2_ft.pth'
    },
    'frozen': {
        'fb1': '/weights_1/shufflenet_v2_fb_1/best_model_shufflenet_v2_fb.pth',
        'fb2': '/weights_2/shufflenet_v2_fb_2/best_model_shufflenet_v2_fb.pth',
        'fb3': '/weights_3/shufflenet_v2_fb_3/best_model_shufflenet_v2_fb.pth'
    },
    'random': {
        'rd1': '/weights_1/shufflenet_v2_rd_1/best_model_shufflenet_v2_rd.pth',
        'rd2': '/weights_2/shufflenet_v2_rd_2/best_model_shufflenet_v2_rd.pth',
        'rd3': '/weights_3/shufflenet_v2_rd_3/best_model_shufflenet_v2_rd.pth'
    },
    'random_b': {
        'rdb1': '/weights_b/shufflenet_v2_rd_1/best_model_shufflenet_v2_rd.pth',
        'rdb2': '/weights_b/shufflenet_v2_rd_2/best_model_shufflenet_v2_rd.pth',
        'rdb3': '/weights_b/shufflenet_v2_rd_3/best_model_shufflenet_v2_rd.pth'
    }
}
